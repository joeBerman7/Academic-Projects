...
public class Table {
    ...
    public void removeCard(int slot) {
        ...
        int row=slot/4;
        int col=slot%4;
        //pass all players and change the token matrix value to false
    ...
    public void placeToken(int player, int slot) {
        // TODO implement
        synchronized (this) {
            playerTokens[player][slot/4][slot%4]=true;
    ...
    public boolean removeToken(int player, int slot) {
        // TODO implement
        synchronized (this) {
            if (playerTokens[player][slot/4][slot%4])
            {
                playerTokens[player][slot/4][slot%4]=false;
